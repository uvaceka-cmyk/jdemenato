...
export default async function Page() {
  ...
  return <><header className="site-header"><Link href="/" className="brand"><span>JdemNa</span><strong>To!</strong></Link><nav><Link href="/dodavatele">Zadat poptávku</Link><a href={signOutPath("/")}>Odhlásit se</a></nav></header><SupplierDashboard email={user.email} profile={profile} requests={requests.results}/></>;
}
