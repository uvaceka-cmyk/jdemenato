...
export function GlobalControls() {
  ...
  return <>
    <button className="feedback-launcher" onClick={() => { setFeedback(true); setSent(false); }}>Ohodnotit JdemNaTo!</button>
